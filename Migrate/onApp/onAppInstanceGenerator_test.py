...
class onAppInstanceGenerator_test(unittest.TestCase):
    ...
    def test_create(self):
        ...
        #generator = onAppInstanceGenerator.onAppInstanceGenerator("portal.4d-cloud.com" , "feoff@migrate2iaas.com", "2c8f8b7d52794d82c365b5e031a6cca2ad8f510a" , 5 , minipad_image_id=382 , vmbuild_timeout = 60*180 , onapp_port = 80)
