...
class WindowsDeviceDataTransferProto(DataTransferProto.DataTransferProto):
    ...
    def __init__(self,devPath,devnumber):
        ...
        self.__hFile = win32file.CreateFile( self.__devicePath, win32con.GENERIC_READ | win32con.GENERIC_WRITE| ntsecuritycon.FILE_READ_ATTRIBUTES | ntsecuritycon.FILE_WRITE_ATTRIBUTES, win32con. FILE_SHARE_READ|win32con.FILE_SHARE_WRITE, secur_att,   win32con.OPEN_EXISTING, win32con.FILE_ATTRIBUTE_NORMAL , 0 )
